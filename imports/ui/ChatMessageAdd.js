...
export default class ChatAdd extends Component {
  ...
  render() {
    return (
      ...
      <textarea className="com-text-2" type="text" role="textbox" placeholder="What message do you want to send?" aria-label="What message do you want to send?" ref="text"/>
